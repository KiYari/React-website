...
const cards = [<CardEx head="Outward" desc="Big desert cooking simulator" imgs='imgs/1.jpg'/>,
                ...
                <CardEx head="How to say step on me in japanese" desc="Weeb is teaching other weebs how to say something in japanese" imgs='imgs/10.jpg' vid='video'/>,
    ...
    <main>
      ...
      <Container className={classes.cardGrid}>
        ...
        <Grid container spacing={3}>
          {cards.map((card) => (
            <Grid className={classes.ytarea} item key={card} xs={12} sm={6} md={3}>
